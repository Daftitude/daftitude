...
export const onboardingIssues = [
  ...
  },
  {
    ...
    price: {
      base: "$75–$150",
      selectedDetails: "$25–$75 if multiple devices, accounts, or network pieces are involved",
...
export const askDaftPriceCards = [
  ...
  },
  {
    ...
    range: "$100–$275+",
    badge: "Premium",
    bestFor: "In-home help, installs, multiple devices, family tech support, smart-home setup, or dedicated hands-on support.",
    includes: ["Visit planning", "Install/setup checklist", "Device/account review"],
  },
  {
    title: "Big / Multi-Project",
    range: "$200–$500+",
...
export const subscribeSavePlans = [
  {
    title: "Check-In",
    price: "$25–$55/mo",
    rhythm: "1 light check-in / month",
    save: "Best for small questions before they become bigger problems.",
    includes: ["Quick message review", "Simple tech questions", "Account/app guidance"],
  },
  {
    title: "Home Tech Care",
    price: "$100–$150/mo",
    rhythm: "1 support session / month",
    save: "Good for families, parents, and people who want regular tech peace of mind.",
    includes: ["Monthly support session", "Device/account upkeep", "Priority familiarity"],
  },
  {
    title: "Priority Care",
    price: "$200–$275/mo",
    rhythm: "2 support touchpoints / month",
    save: "Best if you want recurring help, faster routing, and less re-explaining every time.",
    includes: ["Two monthly touchpoints", "Support history", "Better ongoing context"],
  },
];

export const estimateCards = [
  {
    title: "Quick Ask / Message Check",
    range: "$25–$55",
