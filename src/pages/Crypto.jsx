      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          <div className="card p-4 bg-gray-700 text-white rounded shadow">
            ...
            <p>Live Price: ${prices.eth ? prices.eth.toFixed(2) : '...'}</p>
            <p>Est. Value: ${prices.eth ? (2.203885 * prices.eth).toFixed(2) : '...'}</p>
          </div>
          <div className="card p-4 bg-gray-700 text-white rounded shadow">
            <h3>SOL</h3>
            <p>Balance: 0.000003</p>
            <p>Avg Entry: $204.70</p>
            <p>Live Price: ${prices.sol ? prices.sol.toFixed(2) : '...'}</p>
            <p>Est. Value: ${prices.sol ? (0.000003 * prices.sol).toFixed(4) : '...'}</p>
          </div>
          <div className="card p-4 bg-gray-700 text-white rounded shadow">
            <h3>USDC</h3>
            <p>Balance: $623.78</p>
